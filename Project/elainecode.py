...
class MenuScreen(Screen):
    def __init__(self, **kwargs):
        ...
        self.img = Image(source='C:/Pinardy/SUTD/Digital World/1D/cohort_classroom.jpg')
        self.layout.add_widget(self.img)
        self.button1 = Button(text= 'Settings',on_press= self.changeToSetting)
        self.button2 = Button(text = 'QUIT', on_press = self.quitApp)
